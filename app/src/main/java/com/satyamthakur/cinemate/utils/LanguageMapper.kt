...
object LanguageMapper {
    ...
    fun getEnglishName(isoCode: String): String? {
        val jsonString = jsonStringRaw

        val listType = object : TypeToken<List<LanguageConfig>>() {}.type
        val languageList: List<LanguageConfig> = Gson().fromJson(jsonString, listType)

        val language = languageList.find { it.iso_639_1 == isoCode }
